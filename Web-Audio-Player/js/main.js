...
function initPlayer() {
    ...
    nextButton.addEventListener('click', () => shuffleButton.isChecked ? checkFigure('r') : checkFigure('+'))
    prevButton.addEventListener('click', () => shuffleButton.isChecked ? checkFigure('r') : checkFigure('-'))
    ...
    equalButton.addEventListener('click', () => {
        equal.style.display === 'flex' ? equal.style.display = 'none' : equal.style.display = 'flex'
    })

    listButton.addEventListener('click', () => {
        trackList.style.display === 'block' ? trackList.style.display = 'none' : trackList.style.display = 'block'
    })
    ...
    function startVisual() {
            ...
            if (canvas.isChecked) {
                ...
                for (let i = 0, j = 0; i < 128; i++) {
                    if (i % 2 === 0) {
                        ...
                        gradient.addColorStop(.2, 'skyblue')
                        gradient.addColorStop(.8, 'steelblue')
        ...
        function createFilters() {
            const frequencies = [31, 87, 175, 350, 700, 1400, 2800, 5600, 11200, 16000]
        ...
        function initEvents() {
            freqInputs.forEach((i, j) => {
                i.addEventListener('change', e => {
                    ...
                    equal.querySelector('.frequency-value').innerText = (filters[j].gain.value).toFixed(1) + 'dB'
                })
            })
        }
